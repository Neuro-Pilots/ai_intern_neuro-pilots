...
# Computer vision and NLP are the immediate real-execution priorities. The
# remaining workload contracts are retained for their later implementation.
